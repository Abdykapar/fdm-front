<template>
	<fdm-modal @close="$emit('close')">
		<div slot="content" class="create">
			<div class="create__head">{{ isEdit ? 'Edit airport' : 'Add new airport' }}</div>
			<div class="create__body">
				<form class="form" @submit.prevent="onSubmit">
					...
					<div class="form__row" :class="{ error: errors.has('city') }">
						<label for="city">City</label>
						<select name="city" v-validate="'required'" id="city" v-model="airport.city_id">
