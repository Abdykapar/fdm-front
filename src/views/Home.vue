						...
						>
							...
							<a class="dropdown-item d-flex" href="javascript:void(0);"
								><img
									...
									alt="flag"
								/>
								<span class="align-self-center">&nbsp;Japanese</span></a
							>
							<a class="dropdown-item d-flex" href="javascript:void(0);"
								><img
							...
							<div class="notification-scroll">
									...
									<div class="media">
										...
										<div class="media-body">
											<div class="notification-para">
												<span class="user-name">Shaun Park</span>
												likes your photo.
											</div>
										</div>
									</div>
								...
								<div class="dropdown-item">
									<div class="media">
										...
										<div class="media-body">
											<div class="notification-para">
												<span class="user-name">Kelly Young</span>
												shared your post
											</div>
										</div>
									</div>
					...
					<ul class="list-unstyled menu-categories" id="accordionExample">
						...
						<li class="menu">
							...
							>
								...
								<li>
									<a href="component_bootstrap_carousel.html"
										>Carousel</a
									>
								</li>
								<li>
								...
								<li>
									<a href="component_media_object.html">
										Media Object
									</a>
								</li>
								<li>
						...
						<li class="menu">
							...
							>
								...
								<li>
									<a href="element_buttons_group.html">
										Button Groups
									</a>
								</li>
								<li>
									<a href="element_color_library.html">
										Color Library
									</a>
								</li>
								<li>
						...
						<li class="menu">
							...
							>
								...
								<li>
									<a href="form_input_group_basic.html">
										Input Group
									</a>
								</li>
								<li>
								...
								<li>
									<a href="form_bootstrap_touchspin.html">
										TouchSpin
									</a>
								</li>
								<li>
						...
						<li class="menu">
							...
							>
								...
								<li>
									<a href="auth_lockscreen_boxed.html">
										Unlock Boxed
									</a>
								</li>
								<li>
								...
								<li>
									<a href="auth_pass_recovery.html">
										Recover ID Cover
									</a>
								</li>
							</ul>
						...
						<li class="menu">
							...
							>
								...
								<li>
									<a href="starter_kit_breadcrumbs.html">
										Breadcrumbs
									</a>
								</li>
								<li>
			...
			<div id="content" class="main-content">
				<div class="layout-px-spacing">
					<div class="row layout-top-spacing">
						...
						<div
							class="col-xl-4 col-lg-12 col-md-6 col-sm-12 col-12 layout-spacing"
						>
						...
						<div
							class="col-xl-5 col-lg-12 col-md-6 col-sm-12 col-12 layout-spacing"
						>
										...
										<table class="table">
											...
											<tbody>
												<tr>
													<td>
														<div
															class="td-content customer-name"
														>
															<img
																src="assets/img/90x90.jpg"
																alt="avatar"
...
<script>
	...
	export default {
		...
		mounted() {
			for (const iterator of this.scripts) {
				this.addScripts(iterator);
				// if ('/assets/js/app.js' === iterator) {
